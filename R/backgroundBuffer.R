...
#' region <- qc
#'
#' xx <- occ_data(scientificName = "Fagus grandifolia", recordedBy = NULL, hasCoordinate = TRUE, limit = 500, stateProvince = "Québec")
